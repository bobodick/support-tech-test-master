...
describe('Working Sauce', function () {
    it('should go to Google and click Sauce', async function () {
		...
		await driver.findElement(By.id("fbemail")).sendKeys("abcd@mail.com");
		await driver.findElement(By.id("comments")).sendKeys("Hello World! This is the text for the email.");
